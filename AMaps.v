...
Theorem t_update_neq : forall (A : Type) (m : total_map A) x1 x2 v,
  x1 <> x2 ->
  (x1 !-> v ; m) x2 = m x2.
Proof. intros. unfold t_update. rewrite <- eqb_neq in H. rewrite H. reflexivity. Qed.
...
Lemma t_update_shadow : forall (A : Type) (m : total_map A) x v1 v2,
  (x !-> v2 ; x !-> v1 ; m) = (x !-> v2 ; m).
Proof.
  intros. unfold t_update. apply functional_extensionality. intro. destruct (x =? x0)%string.
...
Proof.
  intros. unfold t_update. apply functional_extensionality. intro.
  destruct (eqb_spec x1 x,eqb_spec x2 x) as [[|] [|]].
  - rewrite e, e0 in H. exfalso. apply H. reflexivity.
